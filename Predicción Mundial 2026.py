...
# --- 1. CONFIGURACIÓN Y ESTÉTICA (Basada en image_cc5b59.png) ---
...
with tab_r:
    ...
    if not es_fecha_edicion:
        st.warning(f"🔒 Los resultados reales se habilitarán el **11 de junio de 2026**.")
    ...
    for zona, equipos in mundial.items():
        ...
        with col1:
            if es_fecha_edicion:
                ...
                st.info("Carga oficial bloqueada hasta el inicio del torneo.")
        with col2:
